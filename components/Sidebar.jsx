...
const sections = [
   {
     ...
     items: [
       ...
       { name: "Support ", path: "/advertisement", icon: Megaphone },
       { name: "Marketing ", path: "/venue-promotion", icon: MapPin },
       { name: "Loyalty ", path: "/tags", icon: Tags },
     ],
   },
    {
//     title: "Venue Related",
    showLimit: 5,
    items: [
      { name: "Security ", path: "/import_data", icon: Upload },
      { name: "Communication ", path: "/leads", icon: UserPlus },
        { name: "Media & Asset Management ", path: "/leads", icon: UserPlus },
        { name: "API ", path: "/leads", icon: UserPlus },
         { name: "Commercial ", path: "/leads", icon: UserPlus },
      // { name: "Import Historical", path: "/historical", icon: Database },
    ],
  },
    ];
